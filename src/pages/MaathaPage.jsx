  ...
  return (
    <div className='maata-page page'>
      ...
      <div className="activities__image">
                    <img src={MaathaImg} alt="Maatha Image" />
                  </div>

      <h1>SMT. ANANTHALAKSHMI NATARAJAN</h1>
<h2>(1943 - 2023)</h2>
<h3>Founder– Shri. P.N. Ramachandra
...
<section className='about component'>
  <div className='about__text'>
    <p>Gurupaadadhooli Smt Ananthalakshmi Natarajan, known in short as
Anantham, and addressed affectionately as 'maataa' (mother), has been
working untiringly for spreading the knowledge of Sanskrit, our shastras
and Indian culture since several decades. Smt.Ananthalaksmi Natarajan
has done her post graduation in mathematics and is a retired teacher of
...
Swamigal of the Sringeri matham, became a sanyasi by the name
Bhashya-swamigal. Being an ardent devotee of the Sringeri acharyas and
encouraged by the revered acharyas and teachers, Smt.Ananthalakshmi
has been giving upanyasams from a tender age of ten!
She gives religious discourses, directs dance dramas, sanskrit dramas
and conducts free sloka and sanskrit classes for one and all. All these
activities are aimed at spreading the messages of Bhagavadgeetha,
educating one and all on the values and purpose of life as enunciated in
the Hindu scriptures, and creating awareness about the richness of the
sanskrit language and Indian culture. Till date, she has directed more
than 300 dance dramas, 150 sanskrit dance dramas and has given
hundreds of upanyasams in various cities through the length and breadth
...
<li>Srimad Bhaagavatham,</li>
<li>Sri Naarayaneeyam,</li>
<li>Srivaishnava Saints and Nayamnar Saints</li>
<li>Mukunda Maala</li>
<li>Bhaktavijaya,</li>
...
spanning across Sanskrit, English, Kannada and Tamil, she writes
regularly for periodicals like Sudharma (the Sanskrit daily) and
Shankara Krupa (the Kannada monthly). She has authored several
books like ‘Geetha-Amrutha-Mahima’, ‘Nayamnar Santaru’,
‘Pavanapurapatimahimaa’ and ‘Shivaleelarnava’ in Kannada and
English. Her book in Kannada, giving meanings for all namas of
...
from all walks of life to promote Bharathiya Samskriti and to undertake
activities of Sanathana Dharma. The trust helps needy students in their
education upto the post graduate level. The trust also conducts free
marriages for deserving couples and disburses free medicines too.</p>
<br />
<p>Smt. Ananthalakshmi Natarajan established the Geetha Govinda
Samskrita Sangha (GGSS) a non-profit organization in 1976, with the
blessings of the Jagadguru of Sringeri, with an aim to nurture and
preserve samskrita and samskriti. For the past 40 years, GGSS has
been conducting shloka and sanskrit classes for students of all age
groups. There is no monetary fees for classes - however, regularity,
punctuality and humility are the fees that students & parents have to
pay. The organization is supported by volunteers who have been
inspired by the pristine life and lofty ideals of Smt.Ananthalakshmi
...
organizations like the Surasaraswathisabha (established by the
Jagadguru of Sringeri), Bharatiya Vidya Bhavan, and the Government
of Karnataka. The syllabus for shlokas includes many stotras of Adi
